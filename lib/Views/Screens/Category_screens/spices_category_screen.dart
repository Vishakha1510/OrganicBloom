...
class SpicesCategoryScreen extends StatefulWidget {
  ...
  @override
  State<SpicesCategoryScreen> createState() => _SpicesCategoryScreenState();
}

class _SpicesCategoryScreenState extends State<SpicesCategoryScreen> {
  @override
                            ...
                            children: [
                              ...
                              IconButton(
                                onPressed: () {
                                  ...
                                  String Id = spices.containsKey('id')
                                      ? spices['id'].toString()
                                      : DateTime.now()
                                  ...
                                  double price = double.tryParse(spices['price']
                                              .replaceAll(
                                                  RegExp(r'[^0-9]'), ''))
                                          ?.toDouble() ??
                                      0.0;
                                  ...
                                  cartProvider.addToCart(
                                    Id,
                                    spices['name'].toString(),
                                    price,
                                    1, // Default quantity to 1 for now
                                    spices['image'].toString(),
                                  );
