...
import 'package:organicbloom/Views/Screens/Detail_screens/bakingsupplies_detail_screen.dart';
            ...
            return GestureDetector(
              onTap: () {
                Navigator.of(context).push(MaterialPageRoute(
                    builder: (context) =>
                        BakingSupplyDetailScreen(supply: bakingsupplies)));
              },
              child: Container(
                            ...
                            children: [
                              ...
                              IconButton(
                                onPressed: () {
                                  ...
                                  String Id = bakingsupplies.containsKey('id')
                                      ? bakingsupplies['id'].toString()
                                      : DateTime.now()
                                  ...
                                  cartProvider.addToCart(
                                    Id,
                                    bakingsupplies['name'].toString(),
                                    price,
                                    1, // Default quantity to 1 for now
                                    bakingsupplies['image'].toString(),
                                  );
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                        content: Text(
                                            "${bakingsupplies['name']} added to cart!")),
                                  );
                                },
