...
class PulsesDetailScreen extends StatefulWidget {
  ...
  const PulsesDetailScreen({super.key, required this.pulse});

  @override
  State<PulsesDetailScreen> createState() => _PulsesDetailScreenState();
}

class _PulsesDetailScreenState extends State<PulsesDetailScreen> {
  int quantity = 1;
                  ...
                  children: [
                    Column(
                      children: [
                        ...
                        SizedBox(height: 5),
                        Text(
                          widget.pulse['nutrition']['Calories'],
                          style: TextStyle(
                            fontSize: 14,
                            color: Colors.grey[700],
                          ),
                    ...
                    Column(
                      children: [
                        ...
                        SizedBox(height: 5),
                        Text(
                          widget.pulse['nutrition']['Protein'],
                          style: TextStyle(
                            fontSize: 14,
                            color: Colors.grey[700],
                          ),
              ...
              Padding(
                ...
                child: GestureDetector(
                  onTap: () {
                    ...
                    // Convert price
                    double price = double.tryParse(widget.pulse['price']
                                .replaceAll(RegExp(r'[^0-9]'), ''))
                            ?.toDouble() ??
                        0.0;

                    cartProvider.addToCart(
                      widget.pulse['id'].toString(),
                      widget.pulse['name'].toString(),
                      price,
                      quantity,
                      widget.pulse['image'].toString(),
                    );

                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                          content:
                              Text("${widget.pulse['name']} added to cart!")),
                    );
                  },
                  child: Container(
                    width: double.infinity,
