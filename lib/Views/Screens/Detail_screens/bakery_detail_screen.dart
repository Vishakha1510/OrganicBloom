              ...
              Padding(
                ...
                child: GestureDetector(
                  onTap: () {
                    ...
                    // Convert price
                    double price = double.tryParse(widget.bakeryItem['price']
                                .replaceAll(RegExp(r'[^0-9]'), ''))
                            ?.toDouble() ??
                        0.0;

                    cartProvider.addToCart(
                      widget.bakeryItem['id'].toString(),
                      widget.bakeryItem['name'].toString(),
                      price,
                      quantity,
                      widget.bakeryItem['image'].toString(),
                    );

                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                          content: Text(
                              "${widget.bakeryItem['name']} added to cart!")),
                    );
                  },
                  child: Container(
                    width: double.infinity,
